...
use forge_provider::config::local_ai::{LocalAiConfig, LocalProviderConfig, ProviderSpecificConfig, HealthCheckConfig};
...
async fn test_local_model_discovery_validation() {
    ...
    // Service creation should still succeed, but validation will catch the invalid URL
